...

                    {
                        ...
                        btnView.setOnMouseClicked(event -> {
                            ...
                            if (selectedBlog != null) {
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/gui/DetailBlog.fxml"));
                        ...
                        btnEdit.setOnMouseClicked(event -> {
                            ...
                            if (selectedBlog != null) {
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/gui/UpdateBlog.fxml"));
                                    Parent root = fxmlLoader.load();
