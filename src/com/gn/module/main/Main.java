...
//        Popover.ctrl.options.getChildren().clear();
    ...
    private void areaChart(){
        title.setText("Salle");
        body.setContent(ViewManager.getInstance().get("Salle"));
    }
    ...
    private void order(){
        ...
        body.setContent(ViewManager.getInstance().get("Order"));
    }
...
@FXML
    private void order_user(){
        title.setText("Orders");
        body.setContent(ViewManager.getInstance().get("Order_User"));
    }
