...
public class Evenements_Index_frontController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        User currentUser = dao2.getUserById(1);
        ...
        try {
            ...
            if(evenements.get(0).getCapacite() == 0){
                reserverBtn.setDisable(true);
            }
            else if(dao3.isReserved(currentUser, evenements.get(0))){
                reserverBtn.setDisable(true);
            }
            ...
            for (i = 1; i < size; i++) {
                try {
                    ...
                    HBox newElementBox = (HBox) FXMLLoader.load(getClass().getResource("Elements/EvenementElement.fxml"));
    ...
    void close(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("EvenementsReservations_Index_back.fxml"));
